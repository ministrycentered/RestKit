...
/**
 ...
 Instances of PCOManagedObjectMapping are used to configure RKObjectMappingOperation instances, which actually
 perform the mapping work. Both object loading and serialization are defined in terms of object mappings.
 */

#import <CoreData/CoreData.h>

@interface PCOManagedObjectMapping : NSObject <RKObjectMappingDefinition>
{
	Class _objectClass;
...
/**
 ...
 [PCOManagedObjectMapping setDefaultDateFormatters:]

 @see [PCOManagedObjectMapping defaultDateFormatters]
 */
...
/**
 ...
 [PCOManagedObjectMapping setPreferredDateFormatter:]

 @see [PCOManagedObjectMapping preferredDateFormatter]
 */
...
/**
 Returns an object mapping targeting the specified class. The PCOManagedObjectMapping instance will
 ...
 [[RKObjectManager sharedManager] postObject:self delegate:self block:^(PCOManagedObjectLoader* loader) {
 loader.objectMapping = [PCOManagedObjectMapping mappingForClass:[Person class] block:^(PCOManagedObjectMapping* mapping) {
...
/**
 Returns serialization mapping for encoding a local object to a dictionary for transport. The PCOManagedObjectMapping instance will
 be yieled to the block so that you can perform on the fly configuration without having to
 obtain a reference variable for the mapping.
 ...
 [[RKObjectManager sharedManager] putObject:self delegate:self block:^(PCOManagedObjectLoader* loader) {
...
/**
 ...
 PCOManagedObjectMapping* catMapping = [PCOManagedObjectMapping mappingForClass:[Cat class]];
 ...
 on the destination class that have the same name.
 @param objectOrDynamicMapping An PCOManagedObjectMapping or RKObjectDynamic mapping to apply when mapping the relationship
 */
...
/**
 ...
 PCOManagedObjectMapping* mapping = [PCOManagedObjectMapping mappingForClass:[User class]];
...
/**
 ...
 @see [PCOManagedObjectMapping defaultValueForMissingAttribute:]
 */
...
/**
 ...
 category.
 */
@interface PCOManagedObjectMapping (DateAndTimeFormatting)
